...
def is_enabled() -> bool:
    """MLflow is enabled if the tracking URI env var is set and package is importable."""
    return bool(os.getenv("MLFLOW_TRACKING_URI")) and _import_mlflow() is not None
