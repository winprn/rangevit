...
# Adopted from https://github.com/xiaoaoran/polarmix/blob/main/core/datasets/utils.py
import numpy as np
...
def polarmix(pts1, labels1, pts2, labels2, alpha, beta):
    ...
    if np.random.random() < 1.0:
        # rotate-copy
        pts_copy, labels_copy = rotate_copy(pts2, labels2)
        # paste
